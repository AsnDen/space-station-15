...
public class JeiPlugin implements IModPlugin {
    ...
    @Override
    public net.minecraft.util.Identifier getPluginUid() {
        return Identifier.of(SpaceStation.MOD_ID, "jei_plugin");
    }

    @Override
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(new SublimationJeiCategory(registration.getJeiHelpers().getGuiHelper()));
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        for (ChemRegistry.GrindingRecipe recipe : ChemRegistry.getGrindingRecipes()) {
            ItemStack input = new ItemStack(net.minecraft.registry.Registries.ITEM.get(recipe.ingredient()));
        ...
        Map<RecipeType<AssemblyJeiRecipe>, List<AssemblyJeiRecipe>> disassemblyRecipes = Map.of(
            DISASSEMBLY_SCREWING, new ArrayList<>(), DISASSEMBLY_WELDING, new ArrayList<>(),
            DISASSEMBLY_PRYING, new ArrayList<>(), DISASSEMBLY_ANCHORING, new ArrayList<>(),
            DISASSEMBLY_IGNITION, new ArrayList<>(), DISASSEMBLY_GENERIC, new ArrayList<>());
        ...
        disassemblyRecipes.forEach((type, recipesForType) -> registration.addRecipes(type, recipesForType));
    }

    private static RecipeType<AssemblyJeiRecipe> disassemblyType(org.technocracy.spacestation.item.components.ToolIngredient tool) {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(org.technocracy.spacestation.registry.ModBlocks.CHEM_MASTER_BLOCK),
                GRINDING, REACTIONS);
        registration.addRecipeCatalyst(new ItemStack(org.technocracy.spacestation.registry.ModBlocks.SUBLIMATOR),
                SUBLIMATION);
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.STEEL_WALL),
            ASSEMBLY);
    }
