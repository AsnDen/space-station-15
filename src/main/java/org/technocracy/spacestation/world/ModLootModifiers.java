...
public class ModLootModifiers {
    ...
    public static void register() {
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            ...
            addSeedLoot(key, tableBuilder, PlantItems.ALOE_SEEDS, Map.of(
                    List.of(
            ...
            addSeedLoot(key, tableBuilder, PlantItems.COTTON_SEEDS, Map.of(
                    List.of(
                            LootTables.VILLAGE_PLAINS_CHEST,
                            LootTables.VILLAGE_SAVANNA_HOUSE_CHEST,
                            LootTables.VILLAGE_TAIGA_HOUSE_CHEST,
            ...
            addSeedLoot(key, tableBuilder, PlantItems.TOMATO_SEEDS, Map.of(
                    List.of(
                            LootTables.VILLAGE_PLAINS_CHEST,
                            LootTables.VILLAGE_SAVANNA_HOUSE_CHEST,
                            LootTables.VILLAGE_TAIGA_HOUSE_CHEST,
            ...
            addSeedLoot(key, tableBuilder, PlantItems.TOWERCAP_SEEDS, Map.of(
                    List.of(
                            LootTables.VILLAGE_PLAINS_CHEST,
                            LootTables.VILLAGE_SAVANNA_HOUSE_CHEST,
                            LootTables.VILLAGE_TAIGA_HOUSE_CHEST,
